...
@Configuration
@EnableJpaRepositories(basePackages = "com.apress.prospring5.ch9.sec6", entityManagerFactoryRef = "emfB")
public class XAJpaConfigB {

    private static Logger logger = LoggerFactory.getLogger(XAJpaConfigB.class);
